...
<a href="<?php echo get_site_url(); ?>/gestion-horas" class="btn btn-outline-info"><i class="fa fa-list"></i> Volver</a>
...
<div class="row">
 ...
 <input type="date" class="form-control" name="gestionHora_fecha_inicial" value="<?php echo $obtener_empleado->fecha_desde; ?>">
 ...
 <input type="date" class="form-control" name="gestionHora_fecha_final" value="<?php echo $obtener_empleado->fecha_hasta; ?>">
...
<div class="row">
 ...
 <div class="form-group">
    <input type="hidden" name="actualizar_gestion_hora_editar">
