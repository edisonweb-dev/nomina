        ...
        <div class="row mb-4">
          ...
          <div class="col-md-4 d-flex justify-content-center align-items-center">
            ...
            <div class="form-group mb-0 mt-3">
                ...
                <button class="btn btn-primary btn-block" name="pdf_reporte_mensual_ganancia_masiva" formtarget="_blank"><i class="fa fa-file mr-2"></i>Generar PDF</button>
