        ...
        <form action="" class="box-new-user" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-md d-flex justify-content-center align-items-center">
              ...
              <div class="form-group mb-0 mt-3">
                ...
                <button class="btn btn-primary btn-block" name="pdf_reporte_anual_ganancia" formtarget="_blank"><i class="fa fa-file mr-2"></i>Generar PDF</button>
