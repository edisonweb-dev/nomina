<?php
    ...
    $pdf->Cell(200,4,utf8_decode('Reporte Ganancias Semanal'),0,1,'C');
    $pdf->Cell(60,4,'',0,1,'C');
    $pdf->Cell(60,4,'',0,1,'C');
    ...
    $pdf->Cell(40,6,utf8_decode('Nombres'),0,0,'C');    
    $pdf->Cell(40,6,utf8_decode('Fecha'),0,0,'C');    
    $pdf->Cell(40,6,utf8_decode('Horas'),0,0,'C');    
    $pdf->Cell(40,6,utf8_decode('Ingresos'),0,1,'C');    
    $pdf->Cell(60,2,'',0,1,'C');
